...
if ($botSettings['dead_man_feature']) {
    ...
    foreach ($lists as $list) {
        ...
        $msg = "<strong>" . $user_data['firstname'] . " " . $user_data['lastname'] . "</strong> " . language('failed_ping_tasks') .
            "_". language('admin_info_ping_time') .date("H:i", strtotime($list['task_start'])) . " - " . date("H:i", strtotime($list['task_end'])) .
            ...
            "__" . language('admin_info_employee') . "/viewEmployee".$user_data['user_id'];
