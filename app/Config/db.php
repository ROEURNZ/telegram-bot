...
$logDir = __DIR__ . $n2 .'/storage/logs';
...
class Database {
    ...
    private function __construct() {
        ...
        // Create connection
        $this->mysqli = new mysqli($dbHost, $dbUsername, $dbPassword, $dbDatabase);
...
try {
    ...
    // Run a test query to check if the connection works
